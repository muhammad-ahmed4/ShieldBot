				...
				<div class="relative z-10">
					...
					<div class="space-y-4">
						...
						{#if $page.data.user?.password}
							...
							>
								<div class="w-10 h-10 bg-gradient-to-br from-indigo-500/20 to-purple-600/20 rounded-lg flex items-center justify-center border border-indigo-500/30 mr-4">
